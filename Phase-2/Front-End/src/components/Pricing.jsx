...
const Pricing = () => {
  return (
    <div className='mt-[150px]'>
        <h1 className='text-white font-rale font-bold lg:text-[55px] text-center mt-8'>Pricing Plans</h1>
        ...
        <div className='lg:flex justify-center items-center space-x-10 px-[50px] py-[70px]'> 
            <div className='border-2 border-white rounded-3xl lg:w-1/3 px-10 py-10'>
                ...
                <div className='mt-6'>
                    <button className='px-10 py-3 font-semibold text-[19=7px] bg-white text-[#6A65FF] rounded-lg'>Choose Plan</button>
                </div>
            </div>
            <div className='relative border-2 border-[#6A65FF] bg-[#6A65FF] rounded-3xl lg:w-1/3 px-10 py-10'>
            {/* <div> */}
                <h1 className='absolute top-[-40px] left-[27%] text-white text-xl bg-[#051139] px-10 py-5 rounded-full border-[3px] border-white'>Most Popular</h1>
            {/* </div> */}
